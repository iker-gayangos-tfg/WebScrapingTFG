...
namespace WebScrapingAPI.Controllers
{
    ...
    public class WebScrapingController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> PruebaGuardarPublicacion()
        {
            try
            {
                IWebDriver driver = new ChromeDriver();

                driver.Navigate().GoToUrl("https://investigacion.ubu.es/documentos/6478d7d82c6d5e7ba65b0d2a#");


                Publicacion publicacionToBd = new Publicacion();
                var titlePublication = driver.FindElement(By.ClassName("documento-detalle__titulo")).Text.ToString();
                publicacionToBd.Title = titlePublication;
                publicacionToBd.Url = "https://investigacion.ubu.es/documentos/6478d7d82c6d5e7ba65b0d2a#";
        ...
        [HttpGet]
        public async Task<IActionResult> PruebaIndicadores()
        {
            try
            {
                IWebDriver driver = new ChromeDriver();

                driver.Navigate().GoToUrl("https://investigacion.ubu.es/documentos/62e5c388e5f0e01a6a1d0ce6#");


                Publicacion publicacionToBd = new Publicacion();
                var titlePublication = driver.FindElement(By.ClassName("documento-detalle__titulo")).Text.ToString();
                publicacionToBd.Title = titlePublication;
                publicacionToBd.Url = "https://investigacion.ubu.es/documentos/62e5c388e5f0e01a6a1d0ce6#";
                ...
                _context.Publicaciones.Add(publicacionToBd);
                await _context.SaveChangesAsync();
                var publicacionBd = await _context.Publicaciones.FirstAsync(x => x.Url == "https://investigacion.ubu.es/documentos/62e5c388e5f0e01a6a1d0ce6#");
                ...
                if (hasIndicators)
                {
                    ...
                    if (divJCR != null)
                    {
                        var tmpJCR = divJCR.FindElements(By.TagName("div")).FirstOrDefault(x => x.Text.Contains("Journal Impact Factor - JIF"));
                        var JCRs = tmpJCR.FindElement(By.TagName("ul")).FindElements(By.TagName("li"));
                        JournalImpactFactor journalImpactFactor = new JournalImpactFactor();
                        journalImpactFactor.FoPublicacion = publicacionBd.Id;
                        var yearJCR = JCRs.FirstOrDefault(x => x.Text.Contains("Año"));
                        if (yearJCR != null)
                    ...
                    if (divSCImago != null)
                    {
                        var tmpSCImago = divSCImago.FindElements(By.TagName("div")).FirstOrDefault(x => x.Text.Contains("SCImago Journal Rank"));
                        var SCImagos = tmpSCImago.FindElement(By.TagName("ul")).FindElements(By.TagName("li"));
                        SCImagoJournalRank sCImagoJournalRank = new SCImagoJournalRank();
                        sCImagoJournalRank.FoPublicacion = publicacionBd.Id;
                        var yearSCImago = SCImagos.FirstOrDefault(x => x.Text.Contains("Año"));
                    ...
                    if (divScopus != null)
                    {
                        var tmpScopus = divScopus.FindElements(By.TagName("div")).FirstOrDefault(x => x.Text.Contains("Scopus CiteScore"));
                        var Scopuss = tmpScopus.FindElement(By.TagName("ul")).FindElements(By.TagName("li"));
                        ScopusCitescore scopusCitescore = new ScopusCitescore();
                        scopusCitescore.FoPublicacion = publicacionBd.Id;
                        var yearScopus = Scopuss.FirstOrDefault(x => x.Text.Contains("Año"));
                    ...
                    if (divJCI != null)
                    {
                        var tmpJCI = divJCI.FindElements(By.TagName("div")).FirstOrDefault(x => x.Text.Contains("Journal Citation Indicator - JCI"));
                        var JCIs = tmpJCI.FindElement(By.TagName("ul")).FindElements(By.TagName("li"));
                        JournalCitationIndicator journalCitationIndicator = new JournalCitationIndicator();
                        journalCitationIndicator.FoPublicacion = publicacionBd.Id;
                        var yearJCI = JCIs.FirstOrDefault(x => x.Text.Contains("Año"));
                        if (yearJCI != null)
        ...
        [HttpGet]
        public async Task<IActionResult> PruebaTesis()
        {
            try
            {
                IWebDriver driver = new ChromeDriver();

                driver.Navigate().GoToUrl("https://investigacion.ubu.es/investigadores/34954/tesis");
        ...
        [HttpGet]
        public async Task<IActionResult> PruebaPatentes()
        {
            try
            {
                IWebDriver driver = new ChromeDriver();

                driver.Navigate().GoToUrl("https://investigacion.ubu.es/investigadores/131521/patentes");
